...
func testMain(m *testing.M) int {
	...
	if runtime.GOOS != "android" {
		...
		if out, err := exec.Command(gocmd, "build", "-o", gomobileBin, "github.com/sagernet/gomobile/cmd/gomobile").CombinedOutput(); err != nil {
			log.Fatalf("gomobile build failed: %v: %s", err, out)
		}
		if out, err := exec.Command(gocmd, "build", "-o", gobindBin, "github.com/sagernet/gomobile/cmd/gobind").CombinedOutput(); err != nil {
...
func TestObjcSeqBench(t *testing.T) {
	...
	runTest(t, []string{"github.com/sagernet/gomobile/bind/testdata/benchmark"}, "", "SeqBench.m", "Benchmark.framework", true, true)
}

// TestObjcSeqWrappers runs ObjC test SeqWrappers.m.
func TestObjcSeqWrappers(t *testing.T) {
	runTest(t, []string{"github.com/sagernet/gomobile/bind/testdata/testpkg/objcpkg"}, "", "SeqWrappers.m", "Objcpkg.framework", false, false)
}

// TestObjcCustomPkg runs the ObjC test SeqCustom.m.
func TestObjcCustomPkg(t *testing.T) {
	runTest(t, []string{"github.com/sagernet/gomobile/bind/testdata/testpkg"}, "Custom", "SeqCustom.m", "Testpkg.framework", false, false)
}
