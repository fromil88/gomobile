...
func TestAndroidBuild(t *testing.T) {
	...
	cmdBuild.flag.Parse([]string{"github.com/sagernet/gomobile/example/basic"})
	oldTags := buildTags
...
func TestRegexImportGolangXPackage(t *testing.T) {
	tests := []struct {
		...
		{"ffffffff t github.com/sagernet/gomobile", "github.com/sagernet/gomobile", 2},
		{"ffffffff t github.com/example/repo/vendor/github.com/sagernet/gomobile", "github.com/sagernet/gomobile", 2},
		{"ffffffff t github.com/example/github.com/sagernet/gomobile", "", 0},
		{"ffffffff t github.com/example/repo", "", 0},
		{"ffffffff t github.com/example/repo/vendor", "", 0},
		{"ffffffff t _github.com/sagernet/gomobile/app", "github.com/sagernet/gomobile/app", 2},
	}
	...
	for _, target := range []string{"android", "ios"} {
		t.Run(target, func(t *testing.T) {
			...
			tests := []struct {
				...
				{
					Name: "Absolute Path",
					Path: "github.com/sagernet/gomobile/example/basic",
				},
				{
					Name: "Relative Path",
					Path: "./example/basic",
