...
var tests = []struct {
...
}{
	{
		name: "ObjC-Testpkg",
		lang: "objc",
		pkg:  "github.com/sagernet/gomobile/bind/testdata/testpkg",
	},
	{
		name: "Java-Testpkg",
		lang: "java",
	...
	},
	{
		name:    "Java-Javapkg",
		lang:    "java",
		pkg:     "github.com/sagernet/gomobile/bind/testdata/testpkg/javapkg",
		goos:    "android",
		reverse: true,
	},
	{
	...
	},
	{
		name: "Go-Cgopkg",
		lang: "go,java,objc",
		pkg:  "github.com/sagernet/gomobile/bind/testdata/cgopkg",
		goos: "android",
	},
}
...
type Struct struct{
	...
	exported := packagestest.Export(t, exporter, []packagestest.Module{
		...
		{
			// gobind requires github.com/sagernet/gomobile to generate code for reverse bindings.
			Name:  "github.com/sagernet/gomobile",
			Files: packagestest.MustCopyFileTree("../.."),
		},
	})
