...
`robpike.io/ivy` and `github.com/sagernet/gomobile` are required dependencies of this main module. In order to update them:

```
  go get -d github.com/sagernet/gomobile@latest
