...
//
//	$ go get -d github.com/sagernet/gomobile/example/network
//	$ gomobile build github.com/sagernet/gomobile/example/network # will build an APK
//
//	# plug your Android device to your computer or start an Android emulator.
//	# if you have adb installed on your machine, use gomobile install to
//	# build and deploy the APK to an Android target.
//	$ gomobile install github.com/sagernet/gomobile/example/network
//
...
//
//	$ go install github.com/sagernet/gomobile/example/network && network
package main
